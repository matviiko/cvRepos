...
import {
  ...
  mdiSass,
  mdiLanguageTypescript, mdiBootstrap, mdiMaterialUi, mdiGithub, mdiUbuntu
} from "@mdi/js";
  ...
  return (
    <div id="Skills" className="container skills">
      ...
      <div className="col-right">
        ...
        { props.skills.skills?.ubuntu ? <a target="_blank" rel="noopener noreferrer" href="https://ubuntu.com"><Icon path={mdiUbuntu} size={5} color={'#d54513'} title="Ubuntu"/></a> : null}
      </div>
    </div>
  )
}